...
@section('page-title', 'Tambah Portofolio Baru')
@section('page-subtitle', 'Unggah gambar hasil karya / produksi baru')
    ...
    <div class="bg-white border border-[#D0D0CC]">
        <div class="p-6 sm:p-8">
            <form action="{{ route('admin.portfolios.store') }}" method="POST" enctype="multipart/form-data">
                ...
                {{-- Gambar --}}
                <div class="mb-8">
                    <label for="images" class="block text-xs font-bold text-[#1A1A1A] uppercase tracking-widest font-['Rajdhani'] mb-2">Gambar Portofolio</label>
                    ...
                    {{-- Container Preview --}}
                    <div id="preview-container" class="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 hidden"></div>
                ...
                <div class="flex items-center gap-4 pt-6 border-t border-[#D0D0CC]">
                    <button type="submit" class="admin-btn">Simpan Portofolio</button>
    ...
    if (input.files && input.files.length > 0) {
        ...
        Array.from(input.files).forEach(file => {
            ...
            reader.onload = function(e) {
                ...
                img.className = 'w-full aspect-square object-cover border border-[#D0D0CC] shadow-sm';
